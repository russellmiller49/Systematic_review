...
const ACTION_GROUPS: { label: string; allPrefix?: string; actions: string[] }[] = [
  ...
  {
    label: "Manuscript",
    allPrefix: "manuscript.",
    actions: [
      "manuscript.created",
      "manuscript.updated",
      "manuscript.reset_to_pico_defaults",
      "manuscript.section.created",
      "manuscript.section.updated",
      "manuscript.section.deleted",
      "manuscript.sections.reordered",
      "manuscript.section.assigned",
      "manuscript.section.status_changed",
      "manuscript.section.version.created",
      "manuscript.section.version.restored",
      "manuscript.section.lock.taken_over",
      "manuscript.comment.created",
      "manuscript.comment.resolved",
      "manuscript.comment.reopened",
      "manuscript.comment.deleted",
      "manuscript.exported",
    ],
  },
  {
